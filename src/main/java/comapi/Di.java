...
public class Di {
    ...
    private boolean nameIsValid(String name) {
        if (singletones.containsKey(name) || factories.containsKey(name) || singletonesFactories.containsKey(name)
    ...
    public Value get(String name) {
        ...
        if (factories.containsKey(name)) {
            return new Value(prepare(factories.get(name).create(this)));
        }
